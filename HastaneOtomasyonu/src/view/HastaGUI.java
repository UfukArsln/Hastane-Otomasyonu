...
public class HastaGUI extends JFrame {
	...
	public HastaGUI(Hasta hasta) throws SQLException {
		...
		w_scrollDoctor.setBounds(10, 36, 260, 314);
		...
		lblPoliklinikAd.setBounds(280, 11, 151, 27);
		w_appointment.add(lblPoliklinikAd);
		
		JComboBox select_clinic = new JComboBox();
		select_clinic.addItem("Poliklinik Seç");
		select_clinic.setBounds(280, 36, 151, 27);
		...
		JLabel lblPoliklinikAd_1 = new JLabel("Doctor Seç");
		lblPoliklinikAd_1.setFont(new Font("Tahoma", Font.BOLD, 15));
		lblPoliklinikAd_1.setBounds(280, 74, 151, 27);
		w_appointment.add(lblPoliklinikAd_1);
		
		JButton btn_selDoctor = new JButton("Doktor Seç");
		btn_selDoctor.addActionListener(new ActionListener() {
			public void actionPerformed(ActionEvent e) {
				...
				if(row >= 0) {
					...
					selectDoctorID = id;
					selectDoctorName = table_doctor.getValueAt(row, 1).toString();
				}else {
					Helper.showMsg("Lütfen bir doktor eçiniz !");
				}
			}
		});
		btn_selDoctor.setFont(new Font("Tahoma", Font.BOLD, 15));
		btn_selDoctor.setBounds(280, 97, 151, 35);
		w_appointment.add(btn_selDoctor);
		
		JLabel lblNewLabel_1_1 = new JLabel("Doktor Listesi");
		lblNewLabel_1_1.setFont(new Font("Tahoma", Font.BOLD, 15));
		lblNewLabel_1_1.setBounds(441, 11, 171, 23);
		w_appointment.add(lblNewLabel_1_1);
		
		JScrollPane w_scrollWhour = new JScrollPane();
		w_scrollWhour.setBounds(441, 36, 260, 314);
		...
		lblPoliklinikAd_1_1.setBounds(280, 143, 151, 27);
		...
		btn_addAppoint.addActionListener(new ActionListener() {
			public void actionPerformed(ActionEvent e) {
				...
				if(selRow >=0) {
					...
					Helper.showMsg("Lütfen geçerli bir değer giriniz !");
				}
			}
		});
		btn_addAppoint.setFont(new Font("Tahoma", Font.BOLD, 15));
		btn_addAppoint.setBounds(280, 166, 151, 35);
		...
		w_scrollAppoint.setBounds(10, 11, 691, 336);
