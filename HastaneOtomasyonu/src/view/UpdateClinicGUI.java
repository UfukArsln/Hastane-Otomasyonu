...
public class UpdateClinicGUI extends JFrame {
	...
	public UpdateClinicGUI(Clinic clinic) {
		...
		lblNewLabel.setBounds(10, 11, 213, 28);
		contentPane.add(lblNewLabel);
		
		fld_clinicName = new JTextField();
		fld_clinicName.setBounds(10, 42, 213, 34);
		...
		btn_updateClinic.setFont(new Font("Tahoma", Font.BOLD, 12));
		btn_updateClinic.setBounds(10, 83, 213, 46);
